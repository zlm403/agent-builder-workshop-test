'use client';
// =========================================================
// ⚠️ @deprecated 僵尸组件（2026-08-26 确认）：全项目无人 import，大屏实际渲染走
// (screen)/page.tsx 的 iframe → public/a3/bigscreen.html（现役实现，含 spec 表现引擎）。
// 本组件的 Tips 弹窗等逻辑已由 bigscreen.html 内联 JS 承接。请勿再在此改业务逻辑；
// 待双实现收敛时删除或封存本文件（见待办清单 A 节）。
// =========================================================

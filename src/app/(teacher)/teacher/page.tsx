...
export default function TeacherPage() {
  ...
  const [moduleHistory, setModuleHistory] = useState<Record<string, { type: 'a0'; data: ScreeningData } | { type: 'normal'; data: Analytics }>>({});
      ...
      <div className="container">
        <div className="card cockpit">
          <div className="cockpit-head">
            <h3 style={{ margin: 0 }}>课堂诊断 · 全部环节</h3>
            <span className="pill blue">实时堆叠 · 往下翻看历史</span>
          </div>
